...
int main(int argc, char* argv[]) 
{
    ...
    std::string filename = "result/1_2_" + to_string(int((1.0-sp[ii]*2)*100 + 0.001)) + "_insert_time.csv";
    exportToCSV(insert_cost_time, filename);
    plt::scatter(ploty1, ploty2);
    plt::save("result/1_2_" + to_string(int((1.0-sp[ii]*2)*100 + 0.001)) +"_mix.jpg");
