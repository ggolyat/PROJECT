...
void process_loop(int ii, int loop) 
{
    try 
    {
        ...
        //cout << 1.0-sp[ii]*2 << endl;
        //cout << total_count*sp[ii] << endl;
        // cout << total_count*sp[ii] << endl;
...
int main(int argc, char* argv[]) 
{
    ...
    std::string filename = "result/1_" + to_string(int((1.0-sp[ii]*2)*100 + 0.001)) + "_insert_time.csv";
    exportToCSV(insert_cost_time, filename);
    plt::scatter(plotx, ploty1);
    plt::save("result/1_" + to_string(int((1.0-sp[ii]*2)*100 + 0.001)) +"_location.jpg");
    plt::scatter(plotx, ploty2);
    plt::save("result/1_" + to_string(int((1.0-sp[ii]*2)*100 + 0.001)) +"_time.jpg");
    return 0;
}
